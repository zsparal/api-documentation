...
recognizable credit card with information gathered from the customers' previous payments is presented and allows the customer to reuse this payment details.
