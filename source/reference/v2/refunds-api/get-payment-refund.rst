...
.. parameter:: settlementAmount
   ...
   Please note that this amount might be recalculated and changed when the status of the refund changes.
   We suggest using the :doc:`List balance transactions </reference/v2/balances-api/list-balance-transactions>`
   endpoint instead to get more accurate settlement amounts for your refunds.
...
.. parameter:: routingReversals
   ...
   payments, refer to the :doc:`Mollie Connect overview </connect/overview>`.
