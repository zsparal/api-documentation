...
The **Reseller API** can be used to register new merchants with Mollie, link existing merchants to your reseller
account, or change settings of merchants that you have referred to Mollie.
...
do the integration all on your own if the scripts do not meet your demands.
...
Do you need support? Please do not hesitate to `contact us <https://www.mollie.com/nl/contact/>`_.
