...
- Added the possibility to :doc:`Refund a split payment </connect/refunds-and-chargebacks>`
- Added ``routing`` optional parameter to the :doc:`Create payment API </reference/v2/payments-api/create-payment>`
- Added ``routing`` optional object to the :doc:`Create payment API </reference/v2/payments-api/create-payment>` and
  :doc:`Get payment API </reference/v2/payments-api/get-payment>` responses
- Added ``reverseRouting`` optional parameter to the :doc:`Create refund API </reference/v2/refunds-api/create-refund>`
- Added ``routingReversal`` optional object to the :doc:`Refund API </reference/v2/refunds-api/get-refund>` response
