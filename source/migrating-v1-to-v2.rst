...
Changes in v2
-------------
In general, the API has adopted the :ref:`HAL specification <https://en.wikipedia.org/wiki/Hypertext_Application_Language>` , allowing you to discover new resources and follow links to new
