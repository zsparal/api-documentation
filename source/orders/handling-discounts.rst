...
^^^^^^^^^^^^^^^^^^^^^^^
You may want to offer 2-for-1 type promotions, or other promotions where the consumer gets a certain percentage off. In
such cases, your customer gets (part of) one item for free.
