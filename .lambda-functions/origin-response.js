...
exports.handler = (event, context, callback) => {
  ...
  response.headers['content-security-policy'] = [
    {
      ...
      value:
        "default-src 'self' assets.docs.mollie.com; img-src 'self' data: assets.docs.mollie.com https://images.ctfassets.net; font-src cdn.mollie.com https://fonts.gstatic.com; script-src assets.docs.mollie.com 'sha256-FPgvfx+DeiJzmOHcDk2Iig1vKX6j8I0pKqPA7y33Xbc=' 'sha256-dSca7Fq9h/m8NPfsEIGN6QsOnwspkqCSOGFBGND+lps=' 'sha256-0M7Y8vfoB3jQRWrbd9UeLZorU2w32qynoWspDQn7U0g=' 'sha256-akWsBON1KU9NUSFengZbPuVOt+8KK3uSXcBP5Hc0sqQ=' 'sha256-nST9yaMPaU/xAS62+YWnvg5TxAXYYQm1Fn5Ybpu0AXM=' 'sha256-q/CGewBJOc0HL8ZusH9Fqnh2aZgLOH7lBvepoEVOrVw='; style-src assets.docs.mollie.com fonts.googleapis.com 'sha256-biLFinpqYMtWHmXfkA1BPeCY0/fNt46SAZ+BBk5YUog='; object-src 'none'; media-src 'none'; form-action 'none'; connect-src algolia.net algolianet.com; report-uri https://mollie.report-uri.com/r/d/csp/enforce",
    },
  ];
  ...
  switch (request.uri.replace(/\/$/, '')) {
    case '/migrating-v1-to-v2':
      ...
      break;
    case '/guides/checkout':
      redirectTo('/payments/hosted-checkout');
      break;
