...
async function run() {
  ...
  if (typeof gtm !== 'string') {
    throw new Error(`Could not load Google Tag Manager snippet from \`./source/theme/google-tag-manager.html\`, expected a string but got \`${typeof gtm}\``);
  }
  ...
  if (!changedFiles.length) {
    throw new Error('Google Tag Manager was not inserted in any file. Was `<!-- GOOGLE_TAG_MANAGER -->` removed from the main layout file?');
  }
